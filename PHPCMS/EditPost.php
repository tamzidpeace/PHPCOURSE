...
datetime='$DateTime', title='$Title', category='$Category', author='$Admin', image='$Image', post='$Post' where id='$EditFromUrl'";
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-10">
            <h1 class="FieldInfo2">Edit Post</h1>
            ...
            <div>
                ...
                ?>
                <form action="EditPost.php?Edit=<?php echo $SearchQueryParameter; ?>" method="post"
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            <span class="FieldInfo">Existing Category: <?php echo $CategoryToBeUpdated . "<br>"; ?></span>
