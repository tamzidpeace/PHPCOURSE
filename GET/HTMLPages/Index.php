...
<html>
<head>
    <title>Index Page Having Common Design</title>
...
<div id="wrap">
        ...
        <div id="side">
            ...
            <section class="sideimage">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore
                    ...
                    culpa qui officia deserunt mollit anim id est laborum. <a href="#">More</a>
                </p></section>
            <br>
            <div class="clear"></div>
            <section class="sideimage">
    ...
    <div id="footer">
        <hr>
        <p>Theme By | Jazeb Akram |&copy;2016-2019 All right reserved.
            <br><a style="color: white; text-decoration: none; cursor: pointer; font-weight:bold;"
                   href="jazebakram.com/coupons" target="_blank">Build reponsive website with html5 and css from
                scratch.</a>
            <br><a style="color: white; text-decoration: none; cursor: pointer; font-weight:bold;"
                   href="jazebakram.com/coupons" target="_blank">Javascript complete and comprehensive for
                beginners. </a>
            <br>CSS Animations & Design for UI UX Designers. finally the best course for moderen deigner is out. after
            previous skillfull courses.
            This site is only used for Study purpose jazebakram.com have all the rights. no one is allow to distribute
            copies other then <br>&trade; jazebakram.com &trade; Udemy ; &trade; Skillshare ; &trade; StackSkills</p>
        <hr>
